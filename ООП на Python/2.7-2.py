...
В случае, если в сеттер передано число, не удовлетворяющее условию, нужно печатать на экран
...
должно сохранятся. В случае, если в сеттер передано число, не удовлетворяющее условию, нужно печатать
...
class Money:
    ...
    def dollars(self, value):
        if isinstance(value, int) and value >= 0:
            ...
            self.total_cents = value * 100 + cents
        else:
            print('Error dollars')
    ...
    def cents(self, value):
        if isinstance(value, int) and 0 <= value and value < 100:
            dollars = self.total_cents // 100
            self.total_cents = dollars * 100 + value
        else:
            print('Error cents')
